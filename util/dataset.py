...
class SemData(Dataset):
    def __init__(self, split=3, shot=1, data_root=None, data_list=None, transform=None, mode='train', use_coco=False,
        ...
        if not use_coco:
            ...
            if use_split_coco:
                print('Using COCO with split partition')
        ...
        print('sub_list(using train): ', self.sub_list)
        print('sub_val_list(using val): ', self.sub_val_list)
